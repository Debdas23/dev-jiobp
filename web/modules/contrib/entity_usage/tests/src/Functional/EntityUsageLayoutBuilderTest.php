 ...
 * @coversDefaultClass \Drupal\entity_usage\Plugin\EntityTrack\Track\LayoutBuilder
 */
class EntityUsageLayoutBuilderTest extends BrowserTestBase {
  ...
  protected function setUp() {
    ...
    $this->config('entity_track.settings')
      ->set('track_enabled_entity_types', ['entity_test', 'block_content'])
