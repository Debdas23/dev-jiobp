...
class ConfigurationFormTest extends EntityUsageJavascriptTestBase {
  ...
  public function testConfigForm() {
    ...
    // Test that the target configuration works. When both node and media are
    // enabled, creating a node pointing to that media asset should record an
    // usage.
    $node2 = Node::create([
      'type' => 'eu_test_ct',
      'title' => 'Test node 2',
    ...
    $source_entity_types_details = $page->find('css', '#edit-track-enabled-entity-types');
